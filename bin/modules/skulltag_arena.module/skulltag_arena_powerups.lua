...
Skulltag.Powerups = {}
Skulltag.Powerups.Init = nil
Skulltag.Powerups.PickupPowerup     = nil
Skulltag.Powerups.RunTickPowerups   = nil
Skulltag.Powerups.NewBeingPowerups  = nil
--Skulltag.Powerups.Ascii = { "@RB", "@LV", "@RD", "@YT", "@CF", "@BP", "@bI", "@NG", "@LA", }
Skulltag.Powerups.Ascii = { "B", "V", "D", "T", "F", "P", "I", "G", "A", }
...
local ActivatePowerupBerserk   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("berserk")
...
local ActivatePowerupInvincible   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("invincible")
...
local ActivatePowerupDoomsphere   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("doomsphere")
...
local ActivatePowerupTurbosphere   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("turbosphere")
...
local ActivatePowerupTimefreeze   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("timefreeze")
...
local ActivatePowerupPartialinvis   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("partialinvisibility")
...
local ActivatePowerupTotalinvis   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("invisibility")
...
local ActivatePowerupGuardsphere   = function (being)
  ...
  Skulltag.AnnouncerPlaySound("guardsphere")
...
Skulltag.Powerups.PickupPowerup       = function (arg_being, arg_powerup, arg_timeout)
...
Skulltag.Powerups.RunNewBeingPowerups = function (arg_being)
...
Skulltag.Powerups.RunTickPowerups     = function ()
  for i = 1, POWER_LIGHTAMP do
    if(player.powerup[i] > 0) then
      --powerup is active
...
Skulltag.Powerups.RunOnKillPowerups   = function (arg_being)
  for i = 1, POWER_LIGHTAMP do
    if(player.powerup[i] > 0) then
      --powerup is active
...
register_item "sp_invincible" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_INVINCIBLE)
    Skulltag.Healing.AddBeingHP(being, being.hpmax, false)
  end
}
register_item "sp_doomsphere" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_DOOMSPHERE)
  end
}
register_item "sp_turbosphere" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_TURBOSPHERE)
  end
}
register_item "sp_timefreeze" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_TIMEFREEZE)
  end
}
register_item "sp_partialinvis" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_PARTIALINVIS)
  end
}
register_item "sp_totalinvis" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_TOTALINVIS)
  end
}
register_item "sp_guardsphere" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_GUARDSPHERE)
  end
}
register_item "sp_lightamp" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, POWER_LIGHTAMP)
  end
}
register_item "sp_random" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Skulltag.Powerups.PickupPowerup(being, math.random(POWER_LIGHTAMP))
  end
}


--init code.
Skulltag.Powerups.Init = function ()
  ...
  for i=2, #beings, 1 do
    ...
    function(self)
      Skulltag.Powerups.RunNewBeingPowerups(self)
    end)
  end
  ...
  for i=2, #beings, 1 do
    ...
    function(self)
      Skulltag.Powerups.RunOnKillPowerups(self)
    end)
  end
end