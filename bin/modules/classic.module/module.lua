module = {
    ...
    drlver = {0,9,9,7},
    type = "episode",
    description = "Classic approach to DRL - 10 levels ending with Cyberdemon, no special levels, no klasses or master traits. At the same time an example of a episodic mod. Includes a badge series.",
    klass = 4,
    challenge = true,
    difficulty = true,
    gsupport = true,
