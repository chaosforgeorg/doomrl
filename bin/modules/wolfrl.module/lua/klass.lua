function DoomRL.load_klasses()
	...
	register_klass "marine"
	{
		...
		desc = "Marines are marines, resilent and hardy. They start with 10 more health points and powerups they use have a +50% duration bonus (+25% on DI).",
	...
	register_klass "scout"
	{
		...
		traits    = {
			...
			{ id = "running",      requires = {{ "dodgemaster",  1 }, { "juggler",     1},                      }, blocks = { "bitch",    "nails", "dualgunner", },               master = true },
		},
	...
	register_klass "technician"
	{
		...
		desc = "Technicians are masters of tinketeering and equipment. They use consumables almost instantly and can devise patrol routes from area maps.",
