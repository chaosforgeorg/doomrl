...
local check_timer_open = function()
    if     (_timer == 200) then
      player:play_sound("dspstart")
      generator.transmute("futuredropwall", "ceiling")
    elseif (_timer == 100) then
      player:play_sound("dspstop")
      generator.transmute("futurepillar", "ceiling")
    end
end
...
Elevator.WaveEngine.Add(future_1a)