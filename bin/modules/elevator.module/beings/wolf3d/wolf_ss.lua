...
register_being "wolf_ss" {
	...
	kill_desc_melee = "killed by an SS nazi",
...
local FixSounds = function()
	beings["wolf_ss"].sound_die   = core.resolve_sound_id("wolf_ss.die")
	beings["wolf_ss"].sound_act   = core.resolve_sound_id("wolf_ss.act")
	beings["wolf_ss"].sound_melee = core.resolve_sound_id("soldier.melee")
end
