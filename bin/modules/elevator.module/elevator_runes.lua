...
Elevator.Runes = {}
Elevator.Runes.Init = nil
Elevator.Runes.PickupRune     = nil
Elevator.Runes.RunTickRunes   = nil
Elevator.Runes.RunOnKillRunes = nil
--Elevator.Runes.Ascii = { " ", "@gã", "@gå", "@Gæ", "@rç", "@Rà", "@Râ", "@Vê", "@rá", "@Gï", "@Yë", }
Elevator.Runes.Ascii = { " ", "ã", "å", "æ", "ç", "à", "â", "ê", "á", "ï", "ë", }
...
local ActivateRuneStrength   = function (being)
  ...
  Elevator.AnnouncerPlaySound("strength")
...
local ActivateRuneResistance   = function (being)
  ...
  Elevator.AnnouncerPlaySound("resistance")
...
local ActivateRuneProsperity   = function (being)
  ...
  Elevator.AnnouncerPlaySound("prosperity")
end
...
local ActivateRuneRage    = function (being)
  ...
  Elevator.AnnouncerPlaySound("rage")
...
local ActivateRuneSpread   = function (being)
  ...
  Elevator.AnnouncerPlaySound("spread")
end
...
local ActivateRuneRegeneration   = function (being)
  ...
  Elevator.AnnouncerPlaySound("regeneration")
end
...
local OnTickRuneRegeneration     = function (being)
  ...
  if(heal >= 1) then
    ...
    Elevator.Healing.AddBeingHP(being, heal, false)
  end
end
...
local ActivateRuneReflection   = function (being)
  ...
  Elevator.AnnouncerPlaySound("reflection")
...
local ActivateRuneDrain   = function (being)
  ...
  Elevator.AnnouncerPlaySound("drain")
end
...
local ActivateRuneHighjump   = function (being)
  ...
  Elevator.AnnouncerPlaySound("highjump")
end
...
local ActivateRuneHaste   = function (being)
  ...
  Elevator.AnnouncerPlaySound("haste")
...
Elevator.Runes.PickupRune     = function(arg_being, arg_rune)
  DeactivateRune(player.rune, arg_being)
  player.rune = arg_rune
  ActivateRune(arg_rune, arg_being)
end
Elevator.Runes.RunNewBeingRunes = function (arg_being)
  NewBeingRune(player.rune, player, arg_being)
end
Elevator.Runes.RunTickRunes   = function()
  OnTickRune(player.rune, player)
end
Elevator.Runes.RunOnKillRunes = function(arg_being)
...
register_item "sr_strength" {
  ...
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_STRENGTH)
  end
}
register_item "sr_resistance" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_RESISTANCE)
  end
}
register_item "sr_prosperity" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_PROSPERITY)
  end
}
register_item "sr_rage" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_RAGE)
  end
}
--[[register_item "sr_spread" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_SPREAD)
  end
}--]]
register_item "sr_regeneration" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_REGENERATION)
  end
}
register_item "sr_reflection" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_REFLECTION)
  end
}
register_item "sr_drain" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_DRAIN)
  end
}
--[[register_item "sr_highjump" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_HIGHJUMP)
  end
}--]]
register_item "sr_haste" {
  ...
  flags      = { IF_GLOBE },
  OnPickup   = function(self,being)
    Elevator.Runes.PickupRune(being, RUNE_HASTE)
  end
}


--init code.
Elevator.Runes.Init = function ()
  --unused
  for i=2, #beings, 1 do
    beings[i].OnCreate = core.create_seq_function(beings[i].OnCreate,
    function(self)
      Elevator.Runes.RunNewBeingRunes(self)
    end)
  end
  ...
  for i=2, #beings, 1 do
    ...
    function(self)
      Elevator.Runes.RunOnKillRunes(self)
    end)
  end
end