...
-- Traditionally contains the special levels or something
-- require( "doomrl:levels/ep1_main" )

-- Main DukeRL lua script file --

function DoomRL.OnLoaded()
	ui.msg('It''s time to kick-ass and chew bubblegum...')
end

function DoomRL.OnLoadBase()
	-- TODO Figure out what all these things do and stub them accordingly
...
function DoomRL.OnLoad()
	-- TODO Figure out and stub accordingly
...
function DoomRL.get_result_id()
	...
	local boss1dead = won and player.depth >= 24
	local boss2dead = player.depth >= 24 and kills.get("jc") > 0
